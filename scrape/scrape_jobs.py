...
driver.get(f'https://www.workatastartup.com/companies?demographic=any&hasEquity=any&hasSalary=any&industry=any&interviewProcess=any&jobType=any&layout=list-compact&locations=US&remote=yes&role=eng&role_type=ml&sortBy=created_desc&tab=any&usVisaNotRequired=any')
sleep(5)
...
input_text.send_keys('I can Design and implement core data infra + pipelines. Help prototype and scale datasets for both model training and finetuning.Work closely with the rest of the team as we build and iterate on product.')
sleep(2)
